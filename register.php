    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Silahkan Registrasi!</h2>
                    <form method="POST">
                        ...
                        <div class="input-group">
                           <input class="input--style-1" type="password" placeholder="Konfirmasi Password" name="cpassword">
                        </div>
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit" name="register">Registrasi</button>
                        </div>
                    </form>
                </div>
            </div>
