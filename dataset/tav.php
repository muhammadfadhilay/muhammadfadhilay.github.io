...
<body>
    ...
    ?>
        <div class="p-5">
            <br><br>
            <a class="btn btn-primary" href="../view/judulbuku.php" role="button">Kembali</a>
            <br><br>
            <table class="table table-striped">
                <thead>
                    <tr>
                    <th scope="col">No</th>
                    <th scope="col">Judul Buku TAV</th>
                ...
                $no=1;
                $ambildata = mysqli_query($conn, "SELECT * FROM tb_book_tav");
