...
<body>
    ...
    ?>
        <div class="p-5">
            <br><br>
            <a class="btn btn-primary" href="../view/informatika.php" role="button">Kembali</a>
            <br><br>
            <table class="table table-striped">
                <thead>
                    <tr>
                    <th scope="col">No</th>
                    <th scope="col">Judul Buku Multimedia</th>
                ...
                $no=1;
                $ambildata = mysqli_query($conn, "SELECT * FROM tb_book_multimedia");
